                ...
                <div class="row">
                    <div class="col-12 mt-3 mx-auto">
                        <div class="card card-body">
                            <h4 class="text-center text-primary"> Edit Unit</h4>
                            <span class="text-success text-center">{{Session::has('message') ? Session::get('message'):''}}</span>
                            <form action="{{route('update.unit',['id'=>$unit->id])}}" class="form-horizontal" method="POST" enctype="multipart/form-data" >
                                @csrf
                                <div class="row mb-3">
                                    <label for="unitName" class="col-3 col-form-label">Unit Name</label>
                                    <div class="col-9">
                                        <input type="text" class="form-control" id="unitName" value="{{$unit->name}}" name="name" placeholder="">
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <label for="unitCode" class="col-3 col-form-label">Unit Code</label>
                                    <div class="col-9">
                                        <input type="text" class="form-control" id="unitCode" value="{{$unit->code}}" name="code" placeholder="">
                                    </div>
                                </div>
                                <div class="row mb-3">
                                ...
                                <div class="justify-content-end row">
                                    <div class="col-9">
                                        <button type="submit" class="btn btn-primary w-50">Update Unit</button>
                                    </div>
                                </div>
                            </form>
