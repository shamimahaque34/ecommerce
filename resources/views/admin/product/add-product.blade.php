                ...
                <div class="row">
                    <div class="col-12 mt-3 mx-auto">
                        <div class="card card-body">
                            ...
                            <form action="{{route('create.product')}}" class="form-horizontal" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div class="row mb-3">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-9">
                                        <input type="text" class="form-control" id="product_name" name="name" placeholder="">
                                    </div>
                                </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-9">
                                        <input type="text" class="form-control" id="product_code" name="code" placeholder="">
                                    </div>
                                </div>
                                <div class="row mb-3">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-9">
                                        <textarea  class="form-control" id="long_description" name="long_description" cols="30" rows="10"></textarea>
                                    </div>
                                </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-9">
                                        <input type="text" class="form-control" id="metaTag" name="meta_tag" placeholder="">
                                    </div>
                                </div>
                                <div class="row mb-3">
