                ...
                <div class="row">
                    <div class="col-12 mt-3 mx-auto">
                        <div class="card card-body">
                            ...
                            <form action="{{route('create.category')}}" class="form-horizontal" method="POST" enctype="multipart/form-data" >
                                @csrf
                                <div class="row mb-3">
                                    <label for="categoryName" class="col-3 col-form-label">Category Name</label>
                                    <div class="col-9">
                                        <input type="text" class="form-control" id="categoryName" name="name" placeholder="">
                                    </div>
                                </div>
                                <div class="row mb-3">
