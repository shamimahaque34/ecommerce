...
<head>
    ...
    <!--Google font-->
    <link href="../../css?family=PT+Sans:400,700&display=swap" rel="stylesheet">
    <link href="../../css-1?family=Raleway&display=swap" rel="stylesheet">
    <!--icon css-->
    ...
    <!-- Theme css -->
    <link rel="stylesheet" type="text/css" href="{{asset('/')}}website/assets/css/color1.css" media="screen" id="color">
</head>
<body class="bg-light">
                    ...
                    <div class="main-menu-block">
                        <div class="menu-left">
                            ...
                            <div class="brand-logo logo-sm-center">
                                <a href="index.html">
                                    <img src="{{asset('/')}}website/assets/images/layout-1/logo/logo.png" class="img-fluid " alt="logo-header">
                                </a>
                            </div>
                        </div>
                                            ...
                                            <li>
                                                <div class="container">
                                                    ...
                                                    <div class="row menu-banner">
                                                        <div class="col-lg-6">
                                                            <div>
                                                                <img src="{{asset('/')}}website/assets/images/layout-2/menu-banner/1.jpg" alt="menu-banner" class="img-fluid">
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-6">
                                                            <div>
                                                                <img src="{{asset('/')}}website/assets/images/layout-2/menu-banner/2.jpg" alt="menu-banner" class="img-fluid">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="container">
                                                    <div class="row">
                                                        ...
                                                        <div class="col mega-box product ">
                                                            <div class="mega-img">
                                                                <img src="{{asset('/')}}website/assets/images/layout-2/menu-banner/3.jpg" alt="menu-banner" class="img-fluid">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                ...
                                <div class="nav-left">
                                    ...
                                    <div class="collapse show nav-desk" id="navbarToggleExternalContent">
                                        <ul class="nav-cat title-font">
                                            <li><a href="category-page(left-sidebar).html"> <img src="{{asset('/')}}website/assets/images/layout-1/nav-img/01.png" alt="catergory-product"> western ware</a></li>
                                            <li><a href="category-page(left-sidebar).html"> <img src="{{asset('/')}}website/assets/images/layout-1/nav-img/02.png" alt="catergory-product"> TV, Appliances</a></li>
                                            <li><a href="category-page(left-sidebar).html"> <img src="{{asset('/')}}website/assets/images/layout-1/nav-img/03.png" alt="catergory-product"> Pets Products</a></li>
                                            <li><a href="category-page(left-sidebar).html"> <img src="{{asset('/')}}website/assets/images/layout-1/nav-img/04.png" alt="catergory-product"> Car, Motorbike</a></li>
                                            <li><a href="category-page(left-sidebar).html"> <img src="{{asset('/')}}website/assets/images/layout-1/nav-img/05.png" alt="catergory-product"> Industrial Products</a></li>
                                            <li><a href="category-page(left-sidebar).html"> <img src="{{asset('/')}}website/assets/images/layout-1/nav-img/06.png" alt="catergory-product"> Beauty, Health Products</a></li>
                                            <li><a href="category-page(left-sidebar).html"> <img src="{{asset('/')}}website/assets/images/layout-1/nav-img/07.png" alt="catergory-product"> Grocery Products </a></li>
                                            <li><a href="category-page(left-sidebar).html"> <img src="{{asset('/')}}website/assets/images/layout-1/nav-img/08.png" alt="catergory-product"> Sports</a></li>
                                            <li><a href="category-page(left-sidebar).html"> <img src="{{asset('/')}}website/assets/images/layout-1/nav-img/09.png" alt="catergory-product"> Bags, Luggage</a></li>
                                            <li><a href="category-page(left-sidebar).html"> <img src="{{asset('/')}}website/assets/images/layout-1/nav-img/10.png" alt="catergory-product"> Movies, Music </a></li>
                                            <li><a href="category-page(left-sidebar).html"> <img src="{{asset('/')}}website/assets/images/layout-1/nav-img/11.png" alt="catergory-product"> Video Games</a></li>
                                            <li><a href="category-page(left-sidebar).html"> <img src="{{asset('/')}}website/assets/images/layout-1/nav-img/08.png" alt="catergory-product"> Sports</a></li>
                                            <li class="mor-slide-open">
                                                <ul>
                                                    <li><a href="category-page(left-sidebar).html"> <img src="{{asset('/')}}website/assets/images/layout-1/nav-img/08.png" alt="catergory-product"> Sports</a></li>
                                                    ...
                                                    <li><a href="category-page(left-sidebar).html"> <img src="{{asset('/')}}website/assets/images/layout-1/nav-img/10.png" alt="catergory-product"> Movies, Music </a></li>
                                                    <li><a href="category-page(left-sidebar).html"> <img src="{{asset('/')}}website/assets/images/layout-1/nav-img/11.png" alt="catergory-product"> Video Games</a></li>
                                                    <li><a href="category-page(left-sidebar).html"> <img src="{{asset('/')}}website/assets/images/layout-1/nav-img/12.png" alt="catergory-product"> Toys, Baby Products</a></li>
                                                </ul>
                                            </li>
                        ...
                        <div class="category-right">
                            ...
                            <div class="btn-group">
                                ...
                                <div class="dropdown-menu gift-dropdown">
                                    <div class="media">
                                        <div class="me-3">
                                            <img src="{{asset('/')}}website/assets/images/icon/1.png" alt="Generic placeholder image">
                                        </div>
                                        <div class="media-body">
                                            <h5 class="mt-0">Billion Days</h5>
                                            <p><img src="{{asset('/')}}website/assets/images/icon/currency.png" class="cash" alt="gift-block"> Flat Rs. 270 Rewards</p>
                                        </div>
                                    </div>
                                    <div class="media">
                                        <div class="me-3">
                                            <img src="{{asset('/')}}website/assets/images/icon/2.png" alt="Generic placeholder image">
                                        </div>
                                        <div class="media-body">
                                            <h5 class="mt-0">Fashion Discount</h5>
                                            <p><img src="{{asset('/')}}website/assets/images/icon/fire.png" class="fire" alt="gift-block">Extra 10% off (upto Rs. 10,000*) </p>
                                        </div>
                                    </div>
                                    <div class="media">
                                        <div class="me-3">
                                            <img src="{{asset('/')}}website/assets/images/icon/3.png" alt="Generic placeholder image">
                                        </div>
                                        <div class="media-body">
                                    ...
                                    <div class="media">
                                        <div class="me-3">
                                            <img src="{{asset('/')}}website/assets/images/icon/6.png" alt="Generic placeholder image">
                                        </div>
                                        <div class="media-body">
                                    ...
                                    <div class="media">
                                        <div class="me-3">
                                            <img src="{{asset('/')}}website/assets/images/icon/5.png" alt="Generic placeholder image">
                                        </div>
                                        <div class="media-body">
                                            <h5 class="mt-0">Beauty store</h5>
                                            <p><img src="{{asset('/')}}website/assets/images/icon/currency.png" class="cash" alt="curancy"> Flat Rs. 270 Rewards</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
        ...
        <div class="row">
                        ...
                        <div class="slider-banner">
                            <div class="slider-img">
                                <ul class="layout2-slide-1">
                                    <li id="img-1"><img src="{{asset('/')}}website/assets/images/layout-1/slider/1.1.png" class="img-fluid" alt="slider"></li>
                                </ul>
                            </div>
                        ...
                        <div class="slider-banner">
                            <div class="slider-img">
                                <ul class="layout2-slide-2">
                                    <li id="img-2"><img src="{{asset('/')}}website/assets/images/layout-1/slider/1.2.png" class="img-fluid" alt="slider"></li>
                                </ul>
                            </div>
                            <div class="slider-banner-contain">
                                <div>
                        ...
                        <div class="slider-banner">
                            <div class="slider-img">
                                <ul class="layout2-slide-3">
                                    <li id="img-3"><img src="{{asset('/')}}website/assets/images/layout-1/slider/1.3.png" class="img-fluid" alt="slider"></li>
                                </ul>
                            </div>
                            <div class="slider-banner-contain">
                                <div>
            ...
            <div class="col-xl-2 col-sm-3 pl-0 offer-banner">
                <div class="offer-banner-img">
                    <img src="{{asset('/')}}website/assets/images/layout-1/offer-banner.png" alt="offer-banner" class="img-fluid  ">
                </div>
    ...
    <div class="custom-container">
        <div class="row collection collection-layout1">
            <div class="col-md-4 offset-xl-2 p-r-md-0">
                <div class="collection-banner-main p-left">
                    <div class="collection-img">
                        <img src="{{asset('/')}}website/assets/images/layout-1/collection-banner/1.jpg" class="img-fluid bg-img  " alt="banner">
                    </div>
            ...
            <div class="col-md-4 col-4">
                <div class="collection-banner-main p-left">
                    <div class="collection-img">
                        <img src="{{asset('/')}}website/assets/images/layout-1/collection-banner/2.jpg" class="img-fluid bg-img  " alt="banner">
                    </div>
                    <div class="collection-banner-contain">
                        <div>
                            <h3>hand</h3>
            ...
            <div class="col-md-2  pl-md-0">
                <div class="collection-banner-main p-top banner-6">
                    <div class="collection-img">
                        <img src="{{asset('/')}}website/assets/images/layout-1/collection-banner/7.jpg" class="img-fluid bg-img  " alt="banner">
                    </div>
                    <div class="collection-banner-contain">
                        <div>
                            <h6>10% off</h6>
                        ...
                        <g>
                            <g>
                                <path d="M409.12,200.741c-4.418,0-8,3.582-8,8c-0.06,106.525-86.464,192.831-192.988,192.772
                                 ...
                                 C417.12,204.323,413.538,200.741,409.12,200.741z"></path>
                            </g>
                        </g>
                        <g>
                            <g>
                                <path d="M200.4,256.341c-3.716-2.516-8.162-3.726-12.64-3.44h-56c1.564-2.442,3.302-4.768,5.2-6.96
                                 ...
                                 c2.291-2.379,3.53-5.579,3.44-8.88C204.691,262.051,203.173,258.598,200.4,256.341z"></path>
                            </g>
                        </g>
                        <g>
                            <g>
                                <path d="M333.76,222.901c-4.254-1.637-8.809-2.346-13.36-2.08h-4.56v-82.48c0-12.373-5.333-18.56-16-18.56
                                 ...
                                 c2.877-2.141,4.425-5.63,4.08-9.2C339.301,228.744,337.319,224.811,333.76,222.901z M289.36,220.581h-45.84l45.84-61.92V220.581z"></path>
                            </g>
                        </g>
                     </svg>
                    <div class="media-body">
            ...
            <div class="col-lg-3 col-md-6  col-sm-12 ">
                <div class="media">
                    <svg version="1.1" xmlns="http://www.w3.org/2000/svg" viewbox="0 0 295.82 295.82" xmlns:xlink="http://www.w3.org/1999/xlink" enable-background="new 0 0 295.82 295.82">
                        <g>
                            <g>
                                <path d="m269.719,43.503h-243.617c-13.921,0-26.102,12.181-26.102,26.102v156.611c0,13.921 12.181,26.102 26.102,26.102h243.617c13.921,0 26.102-12.181 26.102-26.102v-156.611c-0.001-13.921-12.182-26.102-26.102-26.102zm-243.617,17.401h243.617c5.22,0 8.701,3.48 8.701,8.701v13.921h-261.019v-13.921c-1.06581e-14-5.22 3.481-8.701 8.701-8.701zm252.317,40.023v13.921h-261.018v-13.921h261.018zm-8.7,133.989h-243.617c-5.22,0-8.701-3.48-8.701-8.701v-93.966h261.018v93.966c0,5.221-3.48,8.701-8.7,8.701z"></path>
                                <path d="m45.243,172.272h45.243c5.22,0 8.701-3.48 8.701-8.701 0-5.22-3.48-8.701-8.701-8.701h-45.243c-5.22,0-8.701,3.48-8.701,8.701 0.001,5.221 3.481,8.701 8.701,8.701z"></path>
                                <path d="m151.391,191.413h-106.148c-5.22,0-8.701,3.48-8.701,8.701s3.48,8.701 8.701,8.701h106.147c3.48,0 8.701-3.48 8.701-8.701s-3.48-8.701-8.7-8.701z"></path>
                            </g>
                        </g>
                    </svg>
                    <div class="media-body">
    ...
    <div class="container">
        <div class="row hot-1 ">
                    ...
                    <div>
                        <div class="media-banner">
                            ...
                            <div class="media-banner-box">
                                <div class="media">
                                    <a href="product-page(left-sidebar).html">
                                        <img src="{{asset('/')}}website/assets/images/layout-1/media-banner/3.jpg" class="img-fluid  " alt="banner">
                                    </a>
                                    <div class="media-body">
                                        <div class="media-contant">
                                            <div>
                                                <div class="product-detail">
                                                    ...
                                                    <a href="product-page(left-sidebar).html">
                                                        <p> Women's Self Design</p>
                                                    </a>
                                                    <h6>$70.00</h6>
                                                </div>
                                                <div class="cart-info">
                                                    <button class="tooltip-top" data-tippy-content="Add to cart" onclick="openCart()"> <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewbox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-shopping-cart"><circle cx="9" cy="21" r="1"></circle><circle cx="20" cy="21" r="1"></circle><path d="M1 1h4l2.68 13.39a2 2 0 0 0 2 1.61h9.72a2 2 0 0 0 2-1.61L23 6H6"></path></svg> </button>
                            ...
                            <div class="media-banner-box">
                                <div class="media">
                                    <a href="product-page(left-sidebar).html">
                                        <img src="{{asset('/')}}website/assets/images/layout-1/media-banner/4.jpg" class="img-fluid  " alt="banner">
                                    </a>
                                    <div class="media-body">
                                        <div class="media-contant">
                                            <div>
            ...
            <div class="col-lg-2 col-sm-6  col-12">
                <a href="product-page(left-sidebar).html">
                    <div class="Jewellery-banner">
                        <img src="{{asset('/')}}website/assets/images/layout-1/collection-banner/6.jpg" alt="collection-banner" class="img-fluid bg-img">
                        <div class="Jewellery-banner-contian">
                            <h5>save 30% off</h5>
                            <h6>Jewellery</h6>
                        </div>
                    </div>
            ...
            <div class="col-lg-7  col-sm-12 col-12  ">
                <div class="hot-deal hotdeal-two">
                    <div class="hot-deal-box">
                        <div class="slide-1">
                            <div>
                                <div class="hot-deal-contain  hot-deal-contain1 hot-deal-banner-1">
                                    ...
                                    <div class="row hot-deal-subcontain">
                                        <div class="col-lg-4 col-sm-4 col-12">
                                            <div class="hotdeal-right-slick-1 no-arrow">
                                                <a href="product-page(left-sidebar).html">
                                                    <div class="right-slick-img img-wrraper">
                                                        <div>
                                                            <img src="{{asset('/')}}website/assets/images/layout-1/hot-deal/4.jpg" alt="hot-deal" class="img-fluid bg-img ">
                                                        </div>
                                                    </div>
                                                </a>
                                                <a href="product-page(left-sidebar).html">
                                                    <div class="right-slick-img img-wrraper">
                                                        <div>
                                                            <img src="{{asset('/')}}website/assets/images/layout-1/hot-deal/3.jpg" alt="hot-deal" class="img-fluid bg-img ">
                                                        </div>
                                                    </div>
                                                </a>
                                                <a href="product-page(left-sidebar).html">
                                                    <div class="right-slick-img img-wrraper">
                                                        <div>
                                                            <img src="{{asset('/')}}website/assets/images/layout-1/hot-deal/2.jpg" alt="hot-deal" class="img-fluid bg-img ">
                                                        </div>
                                                    </div>
                                                </a>
                                                <a href="product-page(left-sidebar),html">
                                                    <div class="right-slick-img img-wrraper">
                                                        <div>
                                                            <img src="{{asset('/')}}website/assets/images/layout-1/hot-deal/1.jpg" alt="hot-deal" class="img-fluid bg-img ">
                                                        </div>
                                                    </div>
                                                </a>
                                            </div>
                                            ...
                                            <div class="hotdeal-right-slick-1 no-arrow">
                                                <div>
                                                    <div>
                                                        ...
                                                        <h6>$45.30 <span>60.00</span></h6>
                                                        <p>
                                                            it is a long established fact that a reader.
                                                        </p>
                                                        <div class="timer">
                                                            <p id="demo" class="demo1">
                                                      <span>
                                                      25
                                                      <span>days</span>
                                                      </span>
                                                ...
                                                <div>
                                                    <div>
                                                        ...
                                                        <h6>$50.30 <span>80.00</span></h6>
                                                        <p>
                                                            it is a long established fact that a reader.
                                                        </p>
                                                        <div class="timer">
                                                            <p id="demo2" class="demo1">
                                                      <span>
                                                      25
                                                      <span>days</span>
                                                      </span>
                                                ...
                                                <div>
                                                    <div>
                                                        ...
                                                        <h6>$75.30 <span>85.00</span></h6>
                                                        <p>
                                                            it is a long established fact that a reader.
                                                        </p>
                                                        <div class="timer">
                                                            <p id="demo3" class="demo1">
                                                      <span>
                                                      25
                                                      <span>days</span>
                                                      </span>
                                        ...
                                        <div class="col-lg-2 col-sm-2 p-l-md-0">
                                            <div class="hotdeal-right-nav-1">
                                                <div><img src="{{asset('/')}}website/assets/images/layout-1/hot-deal/4.jpg" alt="hot-deal" class="img-fluid  "></div>
                                                <div><img src="{{asset('/')}}website/assets/images/layout-1/hot-deal/3.jpg" alt="hot-deal" class="img-fluid  "></div>
                                                <div><img src="{{asset('/')}}website/assets/images/layout-1/hot-deal/2.jpg" alt="hot-deal" class="img-fluid  "></div>
                                                <div><img src="{{asset('/')}}website/assets/images/layout-1/hot-deal/1.jpg" alt="hot-deal" class="img-fluid  "></div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
    ...
    <div class="container-fluid">
        <div class="row collection2">
            <div class="col-md-4">
                <div class="collection-banner-main p-left">
                    <div class="collection-img">
                        <img src="{{asset('/')}}website/assets/images/layout-1/collection-banner/3.jpg" class="img-fluid bg-img " alt="banner">
                    </div>
                    <div class="collection-banner-contain">
                        <div>
                            <h3>classic</h3>
            ...
            <div class="col-md-4">
                <div class="collection-banner-main p-left">
                    <div class="collection-img">
                        <img src="{{asset('/')}}website/assets/images/layout-1/collection-banner/4.jpg" class="img-fluid bg-img " alt="banner">
                    </div>
                    <div class="collection-banner-contain">
                        <div>
                            <h3>food</h3>
            ...
            <div class="col-md-4">
                <div class="collection-banner-main p-left">
                    <div class="collection-img">
                        <img src="{{asset('/')}}website/assets/images/layout-1/collection-banner/5.jpg" class="img-fluid bg-img  " alt="banner">
                    </div>
                    <div class="collection-banner-contain">
                        <div>
                            <h3>digital</h3>
                                    ...
                                    <div class="product-box">
                                        <div class="product-imgbox">
                                            <div class="product-front">
                                                <a href="product-page(left-sidebar).html">
                                                    <img src="{{asset('/')}}website/assets/images/layout-1/product/1.jpg" class="img-fluid  " alt="product">
                                                </a>
                                            </div>
                                            <div class="product-back">
                                                <a href="product-page(left-sidebar).html">
                                                    <img src="{{asset('/')}}website/assets/images/layout-1/product/a1.jpg" class="img-fluid  " alt="product">
                                                </a>
                                            </div>
                                            <div class="product-icon">
                                                <button onclick="openCart()" class="tooltip-left" data-tippy-content="Add to cart">
                                ...
                                <div>
                                    <div class="product-box">
                                        <div class="product-imgbox">
                                            <div class="product-front">
                                                <a href="product-page(left-sidebar).html">
                                                    <img src="{{asset('/')}}website/assets/images/layout-1/product/2.jpg" class="img-fluid  " alt="product">
                                                </a>
                                            </div>
                                            <div class="product-back">
                                                <a href="product-page(left-sidebar).html">
                                                    <img src="{{asset('/')}}website/assets/images/layout-1/product/a2.jpg" class="img-fluid  " alt="product">
                                                </a>
                                            </div>
                                            <div class="product-icon">
                                                <button onclick="openCart()" class="tooltip-left" data-tippy-content="Add to cart">
                                ...
                                <div>
                                    <div class="product-box">
                                        <div class="product-imgbox">
                                            <div class="product-front">
                                                <a href="product-page(left-sidebar).html">
                                                    <img src="{{asset('/')}}website/assets/images/layout-1/product/3.jpg" class="img-fluid  " alt="product">
                                                </a>
                                            </div>
                                            <div class="product-back">
                                                <a href="product-page(left-sidebar).html">
                                                    <img src="{{asset('/')}}website/assets/images/layout-1/product/a3.jpg" class="img-fluid  " alt="product">
                                                </a>
                                            </div>
                                            <div class="product-icon">
                                                <button onclick="openCart()" class="tooltip-left" data-tippy-content="Add to cart">
                                ...
                                <div>
                                    <div class="product-box">
                                        <div class="product-imgbox">
                                            <div class="product-front">
                                                <a href="product-page(left-sidebar).html">
                                                    <img src="{{asset('/')}}website/assets/images/layout-1/product/4.jpg" class="img-fluid  " alt="product">
                                                </a>
                                            </div>
                                            <div class="product-back">
                                                <a href="product-page(left-sidebar).html">
                                                    <img src="{{asset('/')}}website/assets/images/layout-1/product/a4.jpg" class="img-fluid  " alt="product">
                                                </a>
                                            </div>
                                            <div class="product-icon">
                                                <button onclick="openCart()" class="tooltip-left" data-tippy-content="Add to cart">
                                ...
                                <div>
                                    <div class="product-box">
                                        <div class="product-imgbox">
                                            <div class="product-front">
                                                <a href="product-page(left-sidebar).html">
                                                    <img src="{{asset('/')}}website/assets/images/layout-1/product/5.jpg" class="img-fluid  " alt="product">
                                                </a>
                                            </div>
                                            <div class="product-back">
                                                <a href="product-page(left-sidebar).html">
                                                    <img src="{{asset('/')}}website/assets/images/layout-1/product/a5.jpg" class="img-fluid  " alt="product">
                                                </a>
                                            </div>
                                            <div class="product-icon">
                                                <button onclick="openCart()" class="tooltip-left" data-tippy-content="Add to cart">
                                ...
                                <div>
                                    <div class="product-box">
                                        <div class="product-imgbox">
                                            <div class="product-front">
                                                <a href="product-page(left-sidebar).html">
                                                    <img src="{{asset('/')}}website/assets/images/layout-1/product/6.jpg" class="img-fluid  " alt="product">
                                                </a>
                                            </div>
                                            <div class="product-back">
                                                <a href="product-page(left-sidebar).html">
                                                    <img src="{{asset('/')}}website/assets/images/layout-1/product/a6.jpg" class="img-fluid  " alt="product">
                                                </a>
                                            </div>
                                            <div class="product-icon">
                                                <button onclick="openCart()" class="tooltip-left" data-tippy-content="Add to cart">
                                ...
                                <div>
                                    <div class="product-box">
                                        <div class="product-imgbox">
                                            <div class="product-front">
                                                <a href="product-page(left-sidebar).html">
                                                    <img src="{{asset('/')}}website/assets/images/layout-1/product/7.jpg" class="img-fluid  " alt="product">
                                                </a>
                                            </div>
                                            <div class="product-back">
                                                <a href="product-page(left-sidebar).html">
                                                    <img src="{{asset('/')}}website/assets/images/layout-1/product/a7.jpg" class="img-fluid  " alt="product">
                                                </a>
                                            </div>
                                            <div class="product-icon">
                                                <button onclick="openCart()" class="tooltip-left" data-tippy-content="Add to cart">
                                ...
                                <div>
                                    <div class="product-box">
                                        <div class="product-imgbox">
                                            <div class="product-front">
                                                <a href="product-page(left-sidebar).html">
                                                    <img src="{{asset('/')}}website/assets/images/layout-1/product/8.jpg" class="img-fluid  " alt="product">
                                                </a>
                                            </div>
                                            <div class="product-back">
                                                <a href="product-page(left-sidebar).html">
                                                    <img src="{{asset('/')}}website/assets/images/layout-1/product/a8.jpg" class="img-fluid  " alt="product">
                                                </a>
                                            </div>
                                            <div class="product-icon">
                                                <button onclick="openCart()" class="tooltip-left" data-tippy-content="Add to cart">
                ...
                <div class="slide-6 no-arrow">
                        ...
                        <div class="category-contain">
                            <div class="img-wrapper">
                                <a href="category-page(left-sidebar).html">
                                    <img src="{{asset('/')}}website/assets/images/layout-1/rounded-cat/1.png" alt="category  " class="img-fluid">
                                </a>
                            </div>
                    ...
                    <div>
                        <div class="category-contain">
                            <div class="img-wrapper">
                                <a href="category-page(left-sidebar).html">
                                    <img src="{{asset('/')}}website/assets/images/layout-1/rounded-cat/2.png" alt="category  " class="img-fluid">
                                </a>
                            </div>
                            <a href="category-page(left-sidebar).html" class="btn-rounded">
                                furniture
                    ...
                    <div>
                        <div class="category-contain">
                            <div class="img-wrapper">
                                <a href="category-page(left-sidebar).html">
                                    <img src="{{asset('/')}}website/assets/images/layout-1/rounded-cat/3.png" alt="category  " class="img-fluid">
                                </a>
                            </div>
                            <a href="category-page(left-sidebar).html" class="btn-rounded">
                                bag
                    ...
                    <div>
                        <div class="category-contain">
                            <div class="img-wrapper">
                                <a href="category-page(left-sidebar).html">
                                    <img src="{{asset('/')}}website/assets/images/layout-1/rounded-cat/4.png" alt="category  " class="img-fluid">
                                </a>
                            </div>
                            <a href="category-page(left-sidebar).html" class="btn-rounded">
                                tools
                    ...
                    <div>
                        <div class="category-contain">
                            <div class="img-wrapper">
                                <a href="category-page(left-sidebar).html">
                                    <img src="{{asset('/')}}website/assets/images/layout-1/rounded-cat/5.png" alt="category  " class="img-fluid">
                                </a>
                            </div>
                            <a href="category-page(left-sidebar).html" class="btn-rounded">
                                grocery
                    ...
                    <div>
                        <div class="category-contain">
                            <div class="img-wrapper">
                                <a href="category-page(left-sidebar).html">
                                    <img src="{{asset('/')}}website/assets/images/layout-1/rounded-cat/6.png" alt="category  " class="img-fluid">
                                </a>
                            </div>
                            <a href="category-page(left-sidebar).html" class="btn-rounded">
                                camera
                    ...
                    <div>
                        <div class="category-contain">
                            <div class="img-wrapper">
                                <a href="category-page(left-sidebar).html">
                                    <img src="{{asset('/')}}website/assets/images/layout-1/rounded-cat/7.png" alt="category  " class="img-fluid">
                                </a>
                            </div>
                            <a href="category-page(left-sidebar).html" class="btn-rounded">
                                shoes
                    ...
                    <div>
                        <div class="media-banner ">
                            ...
                            <div class="media-banner-box">
                                <div class="media">
                                    <a href="product-page(left-sidebar).html">
                                        <img src="{{asset('/')}}website/assets/images/layout-1/media-banner/1.jpg" class="img-fluid  " alt="banner">
                                    </a>
                                    <div class="media-body">
                                        <div class="media-contant">
                                            <div>
                            ...
                            <div class="media-banner-box">
                                <div class="media">
                                    <a href="product-page(left-sidebar).html">
                                        <img src="{{asset('/')}}website/assets/images/layout-1/media-banner/2.jpg" class="img-fluid  " alt="banner">
                                    </a>
                                    <div class="media-body">
                                        <div class="media-contant">
                                            <div>
                ...
                <div class="blog-slide no-arrow">
                        ...
                        <div class="blog-contain">
                            <div class="blog-img">
                                <a href="blog-details.html">
                                    <img src="{{asset('/')}}website/assets/images/layout-1/blog/1.jpg" alt="blog" class="img-fluid  w-100">
                                </a>
                            </div>
                    ...
                    <div>
                        <div class="blog-contain">
                            <div class="blog-img">
                                <a href="blog-details.html">
                                    <img src="{{asset('/')}}website/assets/images/layout-1/blog/2.jpg" alt="blog" class="img-fluid  w-100">
                                </a>
                            </div>
                            <div class="blog-details">
                                <a href="blog-details.html">
                    ...
                    <div>
                        <div class="blog-contain">
                            <div class="blog-img">
                                <a href="blog-details.html">
                                    <img src="{{asset('/')}}website/assets/images/layout-1/blog/3.jpg" alt="blog" class="img-fluid  w-100">
                                </a>
                            </div>
                            <div class="blog-details">
                                <a href="blog-details.html">
                ...
                <div class="slide-1 no-arrow">
                        ...
                        <div class="testimonial-contain">
                            <div class="media">
                                <div class="testimonial-img">
                                    <img src="{{asset('/')}}website/assets/images/testimonial/1.jpg" class="img-fluid rounded-circle " alt="testimonial">
                                </div>
                                <div class="media-body">
                                    <h5>mark jecno</h5>
                    ...
                    <div>
                        <div class="testimonial-contain">
                            <div class="media">
                                <div class="testimonial-img">
                                    <img src="{{asset('/')}}website/assets/images/testimonial/2.jpg" class="img-fluid rounded-circle  " alt="testimonial">
                                </div>
                                <div class="media-body">
                                    <h5>mark jecno</h5>
                                    <p>Contrary to popular belief, Lorem Ipsum is not simply random text. It has roots in a piece of classical Latin literature from 45 BC, making it over 2000 years old. Richard McClintock, a Latin professor at Hampden-Sydney College in Virginia.</p>
                    ...
                    <div>
                        <div class="testimonial-contain">
                            <div class="media">
                                <div class="testimonial-img">
                                    <img src="{{asset('/')}}website/assets/images/testimonial/3.jpg" class="img-fluid rounded-circle  " alt="testimonial">
                                </div>
                                <div class="media-body">
                                    <h5>mark jecno</h5>
                                    <p>Contrary to popular belief, Lorem Ipsum is not simply random text. It has roots in a piece of classical Latin literature from 45 BC, making it over 2000 years old. Richard McClintock, a Latin professor at Hampden-Sydney College in Virginia.</p>
...
<!--instagram start-->
<section class="instagram  b-g-white section-big-py-space">
    <div class="container">
        <div class="row">
            <div class="col ">
                <div class="insta-contant insta-contant-inverse no-arrow">
                    <div class="slide-7 no-arrow">
                        <div>
                            <div class="instagram-box">
                                <img src="{{asset('/')}}website/assets/images/insta/1.jpg" class="img-fluid  " alt="insta">
                                <div class="insta-cover">
                                    <i class="fa fa-instagram"></i>
                                </div>
                            </div>
                            <div class="instagram-box">
                                <img src="{{asset('/')}}website/assets/images/insta/2.jpg" class="img-fluid  " alt="insta">
                                <div class="insta-cover">
                                    <i class="fa fa-instagram"></i>
                                </div>
                            </div>
                        ...
                        <div>
                            <div class="instagram-box">
                                <img src="{{asset('/')}}website/assets/images/insta/3.jpg" class="img-fluid  " alt="insta">
                                <div class="insta-cover">
                                    <i class="fa fa-instagram"></i>
                                </div>
                            </div>
                            <div class="instagram-box">
                                <img src="{{asset('/')}}website/assets/images/insta/4.jpg" class="img-fluid  " alt="insta">
                                <div class="insta-cover">
                                    <i class="fa fa-instagram"></i>
                                </div>
                            </div>
                        ...
                        <div>
                            <div class="instagram-box">
                                <img src="{{asset('/')}}website/assets/images/insta/5.jpg" class="img-fluid  " alt="insta">
                                <div class="insta-cover">
                                    <i class="fa fa-instagram"></i>
                                </div>
                            </div>
                            <div class="instagram-box">
                                <img src="{{asset('/')}}website/assets/images/insta/6.jpg" class="img-fluid  " alt="insta">
                                <div class="insta-cover">
                                    <i class="fa fa-instagram"></i>
                                </div>
                            </div>
                        ...
                        <div>
                            <div class="instagram-box">
                                <img src="{{asset('/')}}website/assets/images/insta/7.jpg" class="img-fluid  " alt="insta">
                                <div class="insta-cover">
                                    <i class="fa fa-instagram"></i>
                                </div>
                            </div>
                            <div class="instagram-box">
                                <img src="{{asset('/')}}website/assets/images/insta/8.jpg" class="img-fluid  " alt="insta">
                                <div class="insta-cover">
                                    <i class="fa fa-instagram"></i>
                                </div>
                            </div>
                        ...
                        <div>
                            <div class="instagram-box">
                                <img src="{{asset('/')}}website/assets/images/insta/9.jpg" class="img-fluid  " alt="insta">
                                <div class="insta-cover">
                                    <i class="fa fa-instagram"></i>
                                </div>
                            </div>
                            <div class="instagram-box">
                                <img src="{{asset('/')}}website/assets/images/insta/10.jpg" class="img-fluid  " alt="insta">
                                <div class="insta-cover">
                                    <i class="fa fa-instagram"></i>
                                </div>
                            </div>
                        ...
                        <div>
                            <div class="instagram-box">
                                <img src="{{asset('/')}}website/assets/images/insta/11.jpg" class="img-fluid    " alt="insta">
                                <div class="insta-cover">
                                    <i class="fa fa-instagram"></i>
                                </div>
                            </div>
                            <div class="instagram-box">
                                <img src="{{asset('/')}}website/assets/images/insta/12.jpg" class="img-fluid    " alt="insta">
                                <div class="insta-cover">
                                    <i class="fa fa-instagram"></i>
                                </div>
                            </div>
                        ...
                        <div>
                            <div class="instagram-box">
                                <img src="{{asset('/')}}website/assets/images/insta/13.jpg" class="img-fluid    " alt="insta">
                                <div class="insta-cover">
                                    <i class="fa fa-instagram"></i>
                                </div>
                            </div>
                            <div class="instagram-box">
                                <img src="{{asset('/')}}website/assets/images/insta/14.jpg" class="img-fluid    " alt="insta">
                                <div class="insta-cover">
                                    <i class="fa fa-instagram"></i>
                                </div>
                            </div>
...
<section class="subscribe1 ">
    <img src="{{asset('/')}}website/assets/images/marketplace/subscribe2.png" alt="subscribe" class="bg-img img-fluid">
    <div class="container">
        <div class="row">
            <div class="col-12">
                        ...
                        <div class="footer-box">
                            ...
                            <div class="footer-contant">
                                <div class="footer-logo">
                                    <a href="index.html">
                                        <img src="{{asset('/')}}website/assets/images/layout-1/logo/logo.png" class="img-fluid" alt="logo">
                                    </a>
                                </div>
                    ...
                    <div class="modal-bg">
                        <div class="newslatter-main">
                            ...
                            <div class="imd-wrraper">
                                <img src="{{asset('/')}}website/assets/images/subscribe/2.jpg" alt="newsletterimg" class="img-fluid bg-img">
                            </div>
                        </div>
                    </div>
                </div>
...
<!-- Theme js-->
<script src="{{asset('/')}}website/assets/js/slider-animat-three.js"></script>
